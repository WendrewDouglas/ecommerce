                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="http://www.wdcommerce.com.br/admin/login"><i class="fa fa-lock"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="http://www.wdcommerce.com.br/"><img src="/res/site/img/logo.png"></a></h1>
                    </div>
                </div>
